...
INSERT INTO MERCHANT_ENTITY_USER (ID, USER_ID, ENTITY_ID, MID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), '11111111-1111-1111-1111-111111111111', NULL, 'MID001', 'Admin', 1672501234, 'Admin', 1672501234);

INSERT INTO MERCHANT_ENTITY_USER (ID, USER_ID, ENTITY_ID, MID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), '22222222-2222-2222-2222-222222222222', 'ENTITY001', 'MID002', 'Admin', 1672501234, 'Admin', 1672501234);

INSERT INTO MERCHANT_ENTITY_USER (ID, USER_ID, ENTITY_ID, MID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), '33333333-3333-3333-3333-333333333333', NULL, 'MID003', 'Admin', 1672501234, 'Admin', 1672501234);

INSERT INTO MERCHANT_ENTITY_USER (ID, USER_ID, ENTITY_ID, MID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), '44444444-4444-4444-4444-444444444444', 'ENTITY002', 'MID004', 'Admin', 1672501234, 'Admin', 1672501234);


INSERT INTO MERCHANT_ENTITY_GROUP (ID, MID, ENTITY_ID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), 'MID001', 'ENTITY001', 'Admin', 1672501234, 'Admin', 1672501234);

INSERT INTO MERCHANT_ENTITY_GROUP (ID, MID, ENTITY_ID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), 'MID002', 'ENTITY002', 'Admin', 1672501234, 'Admin', 1672501234);

INSERT INTO MERCHANT_ENTITY_GROUP (ID, MID, ENTITY_ID, CREATED_BY, CREATED_AT, UPDATED_BY, UPDATED_AT) 
VALUES (SYS_GUID(), 'MID003', 'ENTITY003', 'Admin', 1672501234, 'Admin', 1672501234);
